...
@Component({
  selector: 'app-attivita-ricevute',
  templateUrl: './attivita-ricevute.page.html',
  styleUrls: ['./attivita-ricevute.page.scss'],
})

export class AttivitaRicevutePage implements OnInit {
