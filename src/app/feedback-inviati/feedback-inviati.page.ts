...
@Component({
  selector: 'app-feedback-inviati',
  templateUrl: './feedback-inviati.page.html',
  styleUrls: ['./feedback-inviati.page.scss'],
})

export class FeedbackInviatiPage implements OnInit {
