...
@Component({
  selector: 'app-dettagli-candidature',
  templateUrl: './dettagli-candidature.page.html',
  styleUrls: ['./dettagli-candidature.page.scss'],
})

export class DettagliCandidaturePage implements OnInit {
